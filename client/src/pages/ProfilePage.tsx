        ...
        <div className="col-md-4">
          <div className="card shadow-sm">
            <div className="card-body">
              ...
              <p className="mb-1"><strong>Nom :</strong> {user.name || "Non renseigné"}</p>
        ...
        <div className="col-md-8">
          ...
          {user.role === "organizer" && (
            <div className="card shadow-sm">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <h2 className="h6 mb-0">Missions que vous avez créées</h2>
                  <span className="text-muted small">{created.length} mission(s)</span>
                </div>
                {created.length === 0 ? (
                  <p className="mb-0 text-muted">
                    Aucune mission publiée. <Link to="/org">Publiez votre première mission</Link>.
                  </p>
                ) : (
                  <ul className="mb-0" style={{ listStyle: "none", padding: 0 }}>
                    {created.map((opp) => (
