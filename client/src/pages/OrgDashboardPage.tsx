...
export default function OrgDashboardPage() {
  ...
  async function loadMine() {
    ...
    try {
      ...
      if (res.status === 403 || res.status === 401) {
        setError('Reserve aux organisateurs.')
        setLoading(false)
        return
      }
      if (!res.ok) {
      ...
      console.error(err)
      setError('Impossible de charger vos opportunites')
    } finally {
      setLoading(false)
    }
  }
  ...
  async function handleCreate(e) {
    ...
    if (!user || user.role !== 'organizer') {
      setCreateStatus('Reserve aux organisateurs.')
      return
    }

    if (!form.date || !form.startTime || !form.endTime || !form.city) {
      setCreateStatus('Renseignez date, ville, heure debut et fin.')
      return
    }
    ...
    try {
      ...
      console.error(err)
      setCreateStatus(err.message || 'Impossible de creer la mission')
    } finally {
      setCreating(false)
    }
  }
  ...
  async function handleUpdate(id) {
    ...
    try {
      ...
      setEditStatus('Mission mise a jour')
      setEditingId(null)
      setEditForm(null)
      await loadMine()
    } catch (err) {
      console.error(err)
      setEditStatus(err.message || 'Impossible de mettre a jour')
    }
  }
  ...
  async function handleDelete(id) {
    ...
    try {
      ...
      setEditStatus('Mission supprimee')
      await loadMine()
    } catch (err) {
      console.error(err)
      setEditStatus(err.message || 'Impossible de supprimer')
    }
  }
  ...
  if (!user || user.role !== 'organizer') {
    return <p>Reserve aux organisateurs.</p>
  }
      ...
      <div className="row g-4">
          ...
          <div className="card shadow-sm" id="create">
            <div className="card-body">
              ...
              <form className="d-grid gap-3" onSubmit={handleCreate}>
                ...
                <div className="row g-2">
                  <div className="col-6">
                    <label className="form-label small fw-semibold">Heure debut</label>
                    <input
                      type="time"
                      name="startTime"
                      className="form-control"
                ...
                <div>
                  <label className="form-label small fw-semibold">Categories (virgules)</label>
                  <input
                    type="text"
                    name="categories"
                    className="form-control"
                ...
                <button className="btn btn-success" type="submit" disabled={creating}>
                  {creating ? 'Publication...' : 'Creer la mission'}
                </button>
                {createStatus && (
        ...
        <div className="col-lg-7">
          <div className="d-flex align-items-center justify-content-between mb-3">
            <h1 className="h4 mb-0">Vos opportunites</h1>
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  />
                    ...
                    <div className="mt-2">
                      <label className="form-label small">Categories (virgules)</label>
                      <input
                        className="form-control"
                        name="categories"
